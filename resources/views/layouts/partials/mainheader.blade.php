                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets_back/images/logo.png') }}" alt="" height="24">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets_back/images/logo.png') }}" alt="" height="24"> <span class="logo-txt">ART BPN</span>
                                </span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('assets_back/images/github.png') }}" alt="Facebook">
                                                <span>Facebook</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('assets_back/images/bitbucket.png') }}" alt="Twitter">
                                                <span>Twitter</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('assets_back/images/dribbble.png') }}" alt="Histragram">
                                                <span>Histragram</span>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('assets_back/images/dropbox.png') }}" alt="youtobe">
                                                <span>Youtobe</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('assets_back/images/mail_chimp.png') }}" alt="Email">
                                                <span>Email</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('assets_back/images/slack.png') }}" alt="Lain">
                                                <span>Lain</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="#!" class="small text-reset text-decoration-underline"> belum ke baca(3)</a>
                                        </div>
                                    </div>
                                </div>
                                <div data-simplebar="init" style="max-height: 230px;"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                                    <a href="#!" class="text-reset notification-item">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{ asset('assets_back/images/avatar-3.jpg') }}" class="rounded-circle avatar-sm" alt="user-pic">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1">Laura kuswati</h6>
                                                <div class="font-size-13 text-muted">
                                                    <p class="mb-1">Penjelasan pengajuan sertifikat tanah.</p>
                                                    <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>1 menit yang lalu</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="#!" class="text-reset notification-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1">Nina Alatas</h6>
                                                <div class="font-size-13 text-muted">
                                                    <p class="mb-1">pengaduan pelayanan di kanwil katapang</p>
                                                    <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>3 menit yang lalu</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="#!" class="text-reset notification-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1">Yanti batak</h6>
                                                <div class="font-size-13 text-muted">
                                                    <p class="mb-1">pengajuan Gugat cerei</p>
                                                    <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>2 minit yang lallu</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a href="#!" class="text-reset notification-item">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{ asset('assets_back/images/avatar-6.jpg') }}" class="rounded-circle avatar-sm" alt="user-pic">
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <div class="p-2 border-top d-grid">
                                    <a class="btn btn-sm btn-link font-size-14 text-center" href="javascript:void(0)">
                                        <i class="mdi mdi-arrow-right-circle me-1"></i> <span>baca berikutnya..</span> 
                                    </a>
                                </div>
                            </div>
</div>
