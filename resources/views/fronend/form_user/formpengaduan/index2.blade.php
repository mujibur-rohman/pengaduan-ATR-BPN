                            ...
                            <div class="fieldset">
                                ...
                                <div class="field">
                                    ...
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtNomor" name="txtNomor" disabled
                                                required> </div>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtNama"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtEmail"> </div>
                                    </div>
                                </div>
                                <div class="field">
                                    <div class="field-label">No Telpon</div>
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtNo_Telpon"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <div class="field-label">
                                        <h3> II. Uraian Pengaduan </h3>
                                    </div>
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtUraian"> </div>
                                    </div>
                                </div>

                                <div class="field">
                                    <div class="field-label">
                                        <h3>III.Bukti yang di Lampirkan</h3>
                                    </div>
                                    <div class="fiel-value">
                                        <div><input id="bukti1" name="bukti1" type="file" class="form-control">
                                            <input id="bukti2" name="bukti2" type="file" class="form-control">
                                            <input id="bukti3" name="bukti3" type="file" class="form-control">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6" style="margin-top:130px;">
                            <div class="fieldset">
                                <div class="field">
                                    ...
                                    <div class="fiel-value">
                                        <div> <input type="date" class="form-control" id="txtTanggal" name="txtTanggal"
                                ...
                                <div class="field">
                                    ...
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtAlamat"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtPekerjaan"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="fiel-value">
                                        <div><input type="text" class="form-control" id="txtObject"> </div>
                                    </div>
                                </div>
