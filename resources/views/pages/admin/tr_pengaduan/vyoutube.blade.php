            ...
            <div class="container-fluid">
                ...
                <div class="panel-heading" style="margin-bottom:2%">
                    <div class="panel-title col-md-12">
                        ...
                        <h4 class="col-md-4">Transaksi Pengaduan Youtube</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btngetYouTube">Get
                                YouTube</button>
                        </div>
                    </div>
                    </form>
...
@push('script')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#btngetYouTube').click(function() {
                alert("proses loding ... get data YouTube");
                getdata();
            });

            function getdata() {
                alert('proses2 get data YouTube');
            }
