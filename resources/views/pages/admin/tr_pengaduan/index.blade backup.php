        ...
        <div class="container-fluid">
            ...
            <div class="panel-heading" style="margin-bottom:2%">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input name="start_date" type="date" class="form-control" id="txttglawal"
                                                value="{{ $txttglawal }}">
                                        </div>
                                        <label for="staticEmail" class="col-sm-1 col-form-label">s/d</label>
                                        <div class="col-sm-4">
                                            <input name="end_date" type="date" class="form-control" id="txttglakhir"
                                                value="{{ $txttglakhir }}">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-3 col-form-label">Katagori
                                            Pengaduan</label>
                                        <div class="col-sm-4">
                                            <select name="pengaduan_id" id="cmbcatagorikanal" class="form-control">
                                                <option value="1" {{ $kanal_id == "1" ? "selected" : "" }}>Kanal NON
                                                    Medsos</option>
                                                <option value="2" {{ $kanal_id == "2" ? "selected" : "" }}>Kanal Medsos
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="kanal_id" id="cmbkanalpengaduan" class="form-control">
                                                ...
                                                @foreach (\App\Pengaduan_kanal::select('kanal_id','nama_kanal')->get()
                                                as $kanal)
                                                <option value="{{ $kanal->kanal_id }}"
                                                    {{ $kanal->kanal_id == $kanal_id ? 'selected' : '' }}>
                                                    {{ $kanal->nama_kanal }}
                                                </option>
                                                @endforeach
                                                <!--                                            <option value="0">Semua data</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-3 col-form-label">Status
                                            Pengaduan</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-3 col-form-label">Posisi
                                            Pengaduan</label>
                                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <a href="{{ route('indexPusatAdmin') }}"
                                                class="btn btn-default btn-sm btn-flat">Kembali</a>
                                            <button type="submit" class="btn btn-primary" id="btncaridata">Cari Data
                                            </button>
                ...
                <div class="panel-body">
                    <table id="dxdatagrid" class="table table-striped table-bordered table-responsive nowrap"
                        style="width:100%;">
                        <thead>
                            <tr>
                                <th>NO</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-capitalize" style="background-color:#FFCCFF"> {{ $tr_p->nama_status }}
                                </td>
                                @else
                                @if($tr_p->nama_status == "Laporan Diterima")
                                <td class="text-capitalize" style="background-color:#FFFFCC"> {{ $tr_p->nama_status }}
                                </td>
                                @else
                                <td class="text-capitalize" style="color:#ffffff;background-color:#99FF00">
                                    {{ $tr_p->nama_status }}</td>
                                @endif
                                @endif
                            ...
                            <td class="text-capitalize"> {{ $tr_p->leadtime3 }}</td> -->
                                ...
                                <td>
                                    @if($tr_p->nama_status == "Proses Verifikasi")
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Verifikator"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                        style="color:#000000 ;background-color:#FFFFCC;" disabled><i
                                            class="fa fa-edit"></i>Verifikator</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Responder"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                        style="color:#000000 ;background-color:#FFCCFF"><i
                                            class="fa fa-edit"></i>Responder</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Jawab"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                        style="color:#000000 ;background-color:#99FF00" disabled><i
                                            class="fa fa-edit"></i>Respon</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Kembali"
                                        data-toggle="modal" data-target="#modalEditJurusan"><i
                                            class="fa fa-edit"></i>Kembali</button>
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Verifikator"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                        style="color:#000000 ;background-color:#FFFFCC;"><i
                                            class="fa fa-edit"></i>Verifikator</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Responder"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                        style="color:#000000 ;background-color:#FFCCFF" disabled><i
                                            class="fa fa-edit"></i>Responder</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Jawab"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                        style="color:#000000 ;background-color:#99FF00" disabled><i
                                            class="fa fa-edit"></i>Respon</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Kembali"
                                        data-toggle="modal" data-target="#modalEditJurusan" disabled><i
                                            class="fa fa-edit"></i>Kembali</button>
                                    @else
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Verifikator"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Jawab"
                                        data-toggle="modal" data-target="#modalEditJurusan"
                                        style="color:#000000 ;background-color:#99FF00"><i
                                            class="fa fa-edit"></i>Respon</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-flat btnedit_Kembali"
                                        data-toggle="modal" data-target="#modalEditJurusan"><i
                                            class="fa fa-edit"></i>Kembali</button>
                                        ...
                                        <table id="dxdatagridpilih" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-capitalize"> {{ $tr_p->nama_posisi }}</td>
                                                    <td>
                                                        <a href="{{ route('pengaduan_verifikasi', $tr_p->gab_flag_role) }}"
                                                            data-target=""
                                                            class="btn btn-default btn-sm btn-flat">Ok</a>
                                        ...
                                        <table id="dxdatagrid_responder"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-capitalize"> {{ $tr_p->nama_posisi }}</td>
                                                    <td>
                                                        <a href="{{ route('pengaduan_responder', $tr_p->gab_flag_role) }}"
                                                            data-target=""
                                                            class="btn btn-default btn-sm btn-flat">Ok</a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="7" cols="50" id="txtberitaacara"
                                            name="txtberitaacara"></textarea>
                                    </div>
