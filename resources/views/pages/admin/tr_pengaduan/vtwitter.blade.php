            ...
            <div class="container-fluid">
                ...
                <div class="panel-heading" style="margin-bottom:2%">
                    <div class="panel-title col-md-12">
                        ...
                        <h4 class="col-md-4">Transaksi Pengaduan Twitter</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btngetTwitter">Get
                                Twitter</button>
                        </div>
                    </div>
                    </form>
...
@push('script')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#btngetTwitter').click(function() {
                alert("proses loding ... get data Twitter");
                getdata();
            });

            function getdata() {
                alert('proses2 get data Twitter');
            }
