            ...
            <div class="container-fluid">
                ...
                <div class="panel-heading" style="margin-bottom:2%">
                    <div class="panel-title col-md-12">
                        ...
                        <h4 class="col-md-4">Transaksi Pengaduan Instagram</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btngetInstagram">Get
                                Instagram</button>
                        </div>
                    </div>
                    </form>
            ...
            <table id="dxdatagrid" class="table table-striped table-bordered nowrap" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Denisitorus@gmail.com</td>
                        <td>karyawan swasta</td>
                        <td>081344455690</td>
                        <td>Sertifika Informasi</td>
                        <td>DT0002626s</td>
...
@push('script')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#btngetInstagram').click(function() {
                alert("proses loding ... get data Instagram");
                getdata();
            });

            function getdata() {
                alert('proses2 get data Instagram');
            }
