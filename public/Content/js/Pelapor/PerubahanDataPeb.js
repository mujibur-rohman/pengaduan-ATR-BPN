$(function () {
    ...
    $("#gridBox1").dxDropDownBox({
        ...
        placeholder: "Pilih PPE",
        displayExpr: "no_peb",
        dataSource: new DevExpress.data.CustomStore({
            loadMode: "raw",
            key: "id_pel_peb",
            load: function () {
                return $.getJSON(routeApi + "DataChange/ComboPeb1");
            }
        }),
    ...
    $("#gridBox2").dxDropDownBox({
        ...
        dataSource: new DevExpress.data.CustomStore({
            ...
            key: "id_pel_peb",
            load: function () {
                return $.getJSON(routeApi + "DataChange/ComboPeb2");
            }
        }),
        showClearButton: true,
        contentTemplate: function (e) {
            var $dataGrid2 = $("<div id=\"gb2DataGrid\">").dxDataGrid({
                ...
                columns: [
                    ...
                    {
                        caption: "Tanggal Jatuh Tempo PPE",
                        alignment: "right",
                        dataField: "tanggal_jatuh_tempo_peb",
                        dataType: "date",
                        format: "dd-MM-yyyy"
                    },
                    {
    ...
    $("#gridDataChange").dxDataGrid({
        dataSource: new DevExpress.data.CustomStore({
            key: "id_pel_peb_change",
            load: function () {
                return $.getJSON(routeApi + "DataChange/GetPeb");
            },
            remove: function (key) {
                return publicActionRequestMethod(routeApi + "DataChange/DeletePeb?id=" + key, "POST");
            }
        }),
        ...
        columns: [
            {
                ...
                alignment: "left",
                dataField: "id_pel_change_peb",
                lookup: {
                    dataSource: new DevExpress.data.CustomStore({
                        key: "id_pel_change",
                        load: function () {
                            return $.getJSON(routeApi + "DataChange/ComboPeb3");
                        }
                    }),
                ...
                alignment: "center",
                dataField: "old_due_date_peb",
                dataType: "date",
                format: "dd-MM-yyyy",
                width: 140
            }, {
                caption: "Jatuh Tempo Sesudah",
                dataField: "new_due_date_peb",
                alignment: "center",
                dataType: "date",
                format: "dd-MM-yyyy",
                width: 140
        ...
        onCellPrepared: function (e) {
            if (e.column.type === "buttons" && e.rowType === "data") {
                ...
                if (e.data.status_peb !== 0) $del.hide();
            }
        },
        export: {
            enabled: true,
            fileName: "Daftar Perubahan Data PPE"
        },
        onExporting: exp => {
    ...
    function SaveData(elm) {
        ...
        try {
            $.ajax(routeApi + "DataChange/SavePeb", {
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
