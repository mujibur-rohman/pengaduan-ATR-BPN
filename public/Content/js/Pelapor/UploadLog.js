$(function () {
    ...
    let gridDataSource = new DevExpress.data.CustomStore({
        load: function (loadOptions) {
            ...
            if (DownloadData.length > 0) return DownloadData;
                ...
                $.ajax({
                    url: routeApi + "AuditTrail/GetUploadJson",
                    dataType: "json",
                    data: datas,
    ...
    $("#gridUploadTrail").dxDataGrid({
        ...
        columns: ["Username", "Module", "Menu",
            {
                dataField: "UploadDokumen",
                cellTemplate: function (container, opt) {
                    container.append(opt.value);
                }
            },
            "DeviceName", "UserIP",
            {
    ...
    $('#exportData').dxButton({
        ...
        type: "default",
        onClick: function () {
            DownloadData = $("#gridUploadTrail").dxDataGrid("instance").getDataSource().items();
            $("#gridUploadTrail").dxDataGrid("instance").exportToExcel();
        }
    });
    ...
    $('#exportSelected').dxButton({
        ...
        type: "default",
        onClick: function () {
            var data = $("#gridUploadTrail").dxDataGrid("instance").getSelectedRowsData();
            $("#gridUploadTrail").dxDataGrid("instance").exportToExcel(data);
        }
    });
