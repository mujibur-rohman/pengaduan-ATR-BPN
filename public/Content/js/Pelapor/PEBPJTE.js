$(function () {
    ...
    $("#btnSearchPEB").dxButton({
        ...
        onClick: function (e) {
            ...
            var method = "GET";
            var urlPEB = routeApi + "DataPEB/LoadPEBPJT";
    ...
    var BtnInput = $("#btnInput").dxButton({
        ...
        onClick: function () {
            if (viewOnly) {
                ...
                jQuery.ajax({
                    type: "POST",
                    url: routeApi + "DataPEB/PostOnDuty?ParamPEB=" + NoPEB + "&jenis=8",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",

                    success: function (data) {
                        window.location.href = routeApp + "Pelapor/InputPJTE";
                    },
    ...
    $("#uploadExcel").show().dxFileUploader({
        ...
        uploadUrl: routeApp + "Pelapor/PEBPJT",
        ...
        onUploaded: function (d) {
            ...
            reader.onloadend = function (dt) {
                ...
                var CountLoop = 0;
                var arrayTest = ["NO PPE","NO KPPBC","TANGGAL PPE","NPWP PEMILIK BARANG","NAMA PEMILIK BARANG","NOMOR INVOICE","TANGGAL INVOICE","NILAI INVOICE","VALUTA BARANG","NILAI BARANG"];
    ...
    $("#gridContainer1").dxDataGrid({
        ...
        export: {
            ...
            fileName: "Daftar PPE Input PJT Ekspor"
        },
