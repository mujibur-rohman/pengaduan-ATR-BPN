...
function load_datagrid(productsStore, ordersStore) {
    ...
    $("#grid-container").dxDataGrid({
        ...
        columns: [
            ...
            { caption: "TGL INCOMING", dataField: "TGL_INCOMING", dataType: "date", format: "dd-MM-yyyy" },
            ...
            template: function (container, options) {
                $("<div>").appendTo(container).dxDataGrid({
                    ...
                    },
                    {
                        ...
                        //dataType: "number",
                        //editorOptions: {
                        //    value: data.NILAI_ALOKASI,
                        //    onValueChanged: function (e) {
                        //        Nilai_In = Nilai_In - e.value;
                        //        alert("kita" + Nilai_In);
                        //        data.SISA_ALOKASI = Nilai_In;
                    ...
                    onRowRemoving: function (e) {
                        ...
                        if (ViewOnly) {
                            ...
                            var method = "POST"; var pebJSon = routeApi + "DataDHE/LoadUpdateInvoice_Incoming";
...
function isi_data_Excel(datade) {
    $("#excel_container").hide().dxDataGrid({
        ...
        export: {
            enabled: true,
            fileName: "Input Invoice Incoming"
        }
    });
}
//end upload
    ...
    onClick: function (e) {
        ...
        if ($("#dateStart_inc").dxDateBox("instance").option("value") === null || $("#dateEnd_inc").dxDateBox("instance").option("value") === null) {
            ...
            if ($("#dateStart_inc").dxDateBox("instance").option("value") > $("#dateEnd_inc").dxDateBox("instance").option("value")) {
                ...
                var method = "GET";
                var urlPEB = routeApi + "DataPEB/LoadInvoiceIncoming";
                var urlPEB2 = routeApi + "DataPEB/LoadInvoiceIncoming_GROUP";
...
$("#uploadEkspor").show().dxFileUploader({
    ...
    uploadUrl: routeApp + "Pelapor/Invoice_Incoming",
    ...
    onUploaded: function (d) {
        ...
        reader.onloadend = function (dt) {
            ...
            $.ajax({
                url: routeApi + "Netting/UploadInvoice_Incoming",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
    ...
    $.ajax({
        ...
        success: function (k) {
            ...
            for (var i = 0; i < json_object2.length; i++) {
                ...
                products.push({
                    NO_REFERENSI: json_object2[i].NO_REFERENSI, TGL_INCOMING: json_object2[i].TGL_INCOMING, NO_REKENING: json_object2[i].NO_REKENING, NO_DOKUMEN: json_object2[i].NO_DOKUMEN,
