$(function() {
    ...
    if (typeof $('input[name="status"],input[name="sex"],input[name="khususMhs[]"], input[name="khususAyah[]"], input[name="khususIbu[]"]').iCheck !== "undefined") { 
        $('input[name="status"],input[name="sex"],input[name="khususMhs[]"], input[name="khususAyah[]"], input[name="khususIbu[]"]').iCheck({
